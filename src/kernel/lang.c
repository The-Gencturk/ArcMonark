...
static const char* table[LANG_COUNT][MSG_COUNT] = {
    {
        ...
        [MSG_HELP_LIST] = "komutlar: help, clear, about, mem, threads, gfxdemo, mouse, lang, theme, close",
...

    {
        ...
        [MSG_HELP_LIST] = "commands: help, clear, about, mem, threads, gfxdemo, mouse, lang, theme, close",
